...
@implementation UIViewController (TideAddTryLogical)
...
- (void)setTitle:(NSString *)title {
    ...
    [titleLabel setTextColor:RGB_COLOR_String(@"#222222")];
...
- (void)setNavBarBackGroundColor:(UIColor *)color{
    [self.navigationController.navigationBar setBackgroundImage:[RendererThroughMomentSignerRing getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:RendererThroughMomentSignerRingDirectionLevel] forBarMetrics:UIBarMetricsDefault];
