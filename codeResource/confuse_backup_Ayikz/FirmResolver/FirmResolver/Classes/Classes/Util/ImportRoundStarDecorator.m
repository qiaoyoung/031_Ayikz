...
{
    return [ImportRoundStarDecorator filepathForDir:RDVideo
                                     filename:filename];
}

+ (NSString *)filepathForImage:(NSString *)filename
{
    return [ImportRoundStarDecorator filepathForDir:RDImage
                                     filename:filename];
}

+ (NSString *)filepathForMergeForwardFile:(NSString *)filename {
    return [ImportRoundStarDecorator filepathForDir:RDMerge
                                     filename:filename];
}
