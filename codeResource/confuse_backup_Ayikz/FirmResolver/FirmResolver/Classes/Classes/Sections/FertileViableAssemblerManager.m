...
#define kFertileViableAssemblerManagerVersionKey @"kFertileViableAssemblerManagerVersionKey"
...
- (NSString *)calculateAppResPath {
    ...
    NSString *path = [[TowerTinyGranularLarge sharedKit].emoticonBundle pathForResource:kFirmResolver ofType:@".zip"];
    if (!path) {
