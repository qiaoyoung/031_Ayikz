...
@interface CancelHeaderViewModel ()
...
@implementation CancelHeaderViewModel
...
-(void)commitButtonClick
{
    ...
    [DelegateViewportCatalog getWithUrl:Server_user_modifyPass params:dict isShow:YES success:^(id responseObject) {
