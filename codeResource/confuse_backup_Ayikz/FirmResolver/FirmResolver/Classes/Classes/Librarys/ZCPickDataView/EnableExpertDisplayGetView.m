...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _animationView = [[UIView alloc]initWithFrame:CGRectMake(0, [UIApplication sharedApplication].windows.firstObject.frame.size.height+50, [UIApplication sharedApplication].windows.firstObject.frame.size.width, PickerHeight+50+SCREEN_BOTTOM_HEIGHT)];
        _animationView.backgroundColor = [UIColor whiteColor];
        _animationView.userInteractionEnabled = YES;
        [self addSubview:_animationView];
        
        datePicker = [[UIDatePicker alloc]initWithFrame:CGRectMake(0,50, [UIApplication sharedApplication].windows.firstObject.frame.size.width, PickerHeight)];
        ...
        if (@available(iOS 14.0, *)) {
            ...
            datePicker.frame = CGRectMake(0,50, [UIApplication sharedApplication].windows.firstObject.frame.size.width, PickerHeight);
        }
