...
@property (assign, nonatomic) SpiceHandyKnackStyle defaultStyle UI_APPEARANCE_SELECTOR;

/// Represents the type of mask applied when the HUD is displayed.
/// @discussion Default: SpiceHandyKnackMaskTypeNone.
@property (assign, nonatomic) SpiceHandyKnackMaskType defaultMaskType UI_APPEARANCE_SELECTOR;

/// Defines the animation type used when the HUD is displayed.
/// @discussion Default: SpiceHandyKnackAnimationTypeFlat.
@property (assign, nonatomic) SpiceHandyKnackAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
