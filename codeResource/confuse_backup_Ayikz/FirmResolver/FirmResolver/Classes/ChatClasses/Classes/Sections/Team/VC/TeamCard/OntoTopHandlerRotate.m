...
- (UITableViewCell*)builidBlueButtonCell:(id<PreloadHelperGreenEpisode>) bodyData{
    ProjectorFramePhoenix * cell = [self.tableView dequeueReusableCellWithIdentifier:TableButtonCellReuseId];
    if (!cell) {
        cell = [[ProjectorFramePhoenix alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:TableButtonCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
- (UITableViewCell*)builidTeamMemberCell:(id<PreloadHelperGreenEpisode>) bodyData{
    VerifyCloseJunctionRotate * cell = [self.tableView dequeueReusableCellWithIdentifier:TableMemberCellReuseId];
    if (!cell) {
        cell = [[VerifyCloseJunctionRotate alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:TableMemberCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
