...
{
    OrchestratorNotableFinishComposerRoute *emoticonCatalog = [[RefinedTabbarUpgradeStencil sharedManager] emoticonCatalog:NEEKIT_EmojiCatalog];
    if (emoticonCatalog) {
...
{
    OrchestratorNotableFinishComposerRoute *emoticonCatalog = [[RefinedTabbarUpgradeStencil sharedManager] emoticonCatalog:NEEKIT_EmojiGifCatalog];
    if (emoticonCatalog) {
        ElasticRevokeMapFacade *layout = [[ElasticRevokeMapFacade alloc] initEmojiLayout:self.device_width];
        emoticonCatalog.layout = layout;
        emoticonCatalog.pagesCount = [self numberOfPagesWithEmoticon:emoticonCatalog];
