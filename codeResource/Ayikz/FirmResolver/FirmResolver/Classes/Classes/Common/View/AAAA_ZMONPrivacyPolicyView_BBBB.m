//
//  AAAA_ZMONPrivacyPolicyView_BBBB.m
//  NIM
//
...
@interface AAAA_ZMONPrivacyPolicyView_BBBB ()<WKNavigationDelegate, WKUIDelegate>
...
@implementation AAAA_ZMONPrivacyPolicyView_BBBB
...
//    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:[AAAA_MyUserDefaults_BBBB standardUserDefaults].yshref]];
...
- (void)animationAgree
{
    [AAAA_MyUserDefaults_BBBB standardUserDefaults].yspop = @"1";
    [self animationClose];
}
