...
//: @implementation CoherentFinishFillRest
@implementation CoherentFinishFillRest
//: - (BOOL)shouldIgnoreMessage:(NIMMessage *)message
- (BOOL)shouldIgnoreMessage:(NIMMessage *)message
{
    //: NIMMessageType type = [ProvisionGraphBinderAssign sharedConfig].ignoreMessageType;
    NIMMessageType type = [ProvisionGraphBinderAssign map].kitSiteType;
...
- (BOOL)shouldIgnoreNotification:(NIMNotificationObject *)notification
{
    ...
    {
        //: NSArray *types = [[ProvisionGraphBinderAssign sharedConfig] ignoreTeamNotificationTypes];
        NSArray *types = [[ProvisionGraphBinderAssign map] ignore];
