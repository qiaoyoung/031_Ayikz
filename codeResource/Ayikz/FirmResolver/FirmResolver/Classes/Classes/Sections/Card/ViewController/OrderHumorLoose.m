...
@interface OrderHumorLoose ()<NIMUserManagerDelegate>
...
@implementation OrderHumorLoose
...
-(void)sendAddFriendRequest{
    ...
    NSString *contact_tag_fragment_add_success = LangKey(@"contact_tag_fragment_add_success");//@"添加成功".user_localized
    NSString *request_successful = LangKey(@"request_successful");//@"请求成功".user_localized
    NSString *add_friend_add_fail = LangKey(@"add_friend_add_fail");//@"添加失败".user_localized
    NSString *add_friend_request_fail = LangKey(@"add_friend_request_fail");//@"请求失败".user_localized
