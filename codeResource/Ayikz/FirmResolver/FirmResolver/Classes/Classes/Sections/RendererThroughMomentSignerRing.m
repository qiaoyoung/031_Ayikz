//
//  RendererThroughMomentSignerRing.m
//  sohunews
//
...
@implementation RendererThroughMomentSignerRing
...
+ (UIImage *)getLinearGradientImage:(UIColor *)startColor and:(UIColor *)endColor directionType:(RendererThroughMomentSignerRingDirection)directionType {
    return [self getLinearGradientImage:startColor and:endColor directionType:directionType option:CGSizeMake(SCREEN_WIDTH, SCREEN_TOP_HEIGHT)];
}
...
+ (UIImage *)getLinearGradientImage:(UIColor *)startColor and:(UIColor *)endColor directionType:(RendererThroughMomentSignerRingDirection)directionType option:(CGSize)size {
    ...
    if (directionType == RendererThroughMomentSignerRingDirectionLevel) {
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 0);
    }else if (directionType == RendererThroughMomentSignerRingDirectionVertical){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(0, 1);
    }else if (directionType == RendererThroughMomentSignerRingDirectionVerticalOverTurn){
        gradientLayer.startPoint = CGPointMake(0, 1);
        gradientLayer.endPoint = CGPointMake(0, 0);
    }else if (directionType == RendererThroughMomentSignerRingDirectionUpwardDiagonalLine){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 1);
    }else if (directionType == RendererThroughMomentSignerRingDirectionDownDiagonalLine){
        gradientLayer.startPoint = CGPointMake(0, 1);
        gradientLayer.endPoint = CGPointMake(1, 0);
    }
...
+ (UIImage *)getRadialGradientImage:(UIColor *)centerColor and:(UIColor *)outColor {
    return [self getRadialGradientImage:centerColor and:outColor option:CGSizeMake(SCREEN_WIDTH, SCREEN_TOP_HEIGHT)];
}
