...
-(void)getGroupData{
    ...
    [DelegateViewportCatalog getWithUrl:Server_group_searchall params:nil isShow:NO success:^(id responseObject) {
...
-(void)newGroupSyncRequest:(NSString *)groupName teamID:(NSString *)teamId{
    ...
    dict[@"name"] = groupName;
    dict[@"id"] = teamId;
    [DelegateViewportCatalog getWithUrl:Server_team_create params:dict isShow:NO success:^(id responseObject) {
