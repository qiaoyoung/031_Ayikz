...
//    [SpiceHandyKnack show];
    ...
    [DelegateViewportCatalog uploadImagesWithURL:Server_other_feedback parameters:dict images:array imageNames:nameArray progress:^(NSProgress *progress) {
...
//        [SpiceHandyKnack dismiss];
        [self.loadingView animationClose];
        [SpiceHandyKnack showMessage:LangKey(@"group_info_activity_op_failed")];
    }];
...
- (UIImagePickerController *)imagePickerVc {
    if (_imagePickerVc == nil) {
        ...
        _imagePickerVc.navigationBar.barTintColor = [UIColor colorWithPatternImage:[RendererThroughMomentSignerRing getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:RendererThroughMomentSignerRingDirectionLevel]];
