...
- (void)initUI{
    _box = [[UIView alloc]initWithFrame:CGRectMake(15, (SCREEN_HEIGHT-532)/2, SCREEN_WIDTH-30, 532)];
    _box.backgroundColor = [UIColor whiteColor];
    _box.layer.cornerRadius = 12;
    [self addSubview:_box];
    
    [_box addSubview:self.img];
    self.img.frame = CGRectMake((SCREEN_WIDTH-30-80)/2, -40, 80, 80);
    
    [_box addSubview:self.titleLabel];
    self.titleLabel.frame = CGRectMake(0, self.img.bottom+10, SCREEN_WIDTH-30, 20);
    
    UILabel *labtitle = [[UILabel alloc] initWithFrame:CGRectMake(20, self.titleLabel.bottom+10, SCREEN_WIDTH-70, 20)];
    labtitle.font = [UIFont systemFontOfSize:14.f];
    labtitle.textColor = kTextColor_2c3042;
    labtitle.textAlignment = NSTextAlignmentCenter;
    labtitle.text = LangKey(@"Confirm_Account_Deletion");
...
//    self.nextBox.frame = CGRectMake(20, labtitle.bottom+10, SCREEN_WIDTH-70, 54);
    ...
    self.contentBox.frame = CGRectMake(20, labtitle.bottom+10, SCREEN_WIDTH-70, 360);
...
- (UIView *)contentBox
{
    if(!_contentBox){
        ...
        labtitle1.text = LangKey(@"Consequences_Account_Deletion");
        ...
        labsubtitle1.text = LangKey(@"Consequences_Account_Deletion_content");
        ...
        labtitle2.text = LangKey(@"Explanation_Data_Deletion");
        ...
        labsubtitle2.text = LangKey(@"Explanation_Data_Deletion_content");
        ...
        labtitle3.text = LangKey(@"Irreversible_Operation");
        ...
        labsubtitle3.text = LangKey(@"Irreversible_Operation_content");
...
//        labprotocol.text = @"I have read and agree to the account deactivation terms";
        ...
        NSMutableAttributedString *tncString = [[NSMutableAttributedString alloc] initWithString:LangKey(@"agree_account_deletion_terms")];
        [tncString addAttribute:NSUnderlineStyleAttributeName
                          value:@(NSUnderlineStyleSingle)
                          range:(NSRange){0,[tncString length]}];
        [tncString addAttribute:NSForegroundColorAttributeName value:RGB_COLOR_String(@"#2C3042")  range:NSMakeRange(0,[tncString length])];
        [tncString addAttribute:NSUnderlineColorAttributeName value:RGB_COLOR_String(@"#2C3042") range:(NSRange){0,[tncString length]}];
