//
//  AAAA_TeamMemberNormalViewController_BBBB.m
//  Riverla
//
...
@interface AAAA_TeamMemberNormalViewController_BBBB ()<UICollectionViewDelegate, UICollectionViewDataSource,AAAA_NIMContactSelectDelegate_BBBB>
...
@implementation AAAA_TeamMemberNormalViewController_BBBB
...
- (void)setupUI {
    ...
    [self.collectionView registerClass:[AAAA_TeamMemberNormalCollectionViewCell_BBBB class] forCellWithReuseIdentifier:@"AAAA_TeamMemberNormalCollectionViewCell_BBBB"];
        ...
        if (!error) {
            for (NIMTeamMember *member in members) {
                if (member.type == NIMTeamMemberTypeNormal) {
                    ...
                    AAAA_FFFKitInfo_BBBB *info = [[AAAA_MyUserKit_BBBB sharedKit] infoByUser:member.userId option:nil];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    AAAA_TeamMemberNormalCollectionViewCell_BBBB *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"AAAA_TeamMemberNormalCollectionViewCell_BBBB" forIndexPath:indexPath];
    //    cell.delegate = self;
...
//        [self.navigationController pushViewController:vc animated:YES];
        ...
        AAAA_USERPersonalCardViewController_BBBB *vc = [[AAAA_USERPersonalCardViewController_BBBB alloc] initWithUserId:member.userId];
        [self.navigationController pushViewController:vc animated:YES];
    }
}
