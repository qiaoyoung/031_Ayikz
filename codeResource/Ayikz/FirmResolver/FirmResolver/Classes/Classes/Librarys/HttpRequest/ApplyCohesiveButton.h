...
extern __attribute__((visibility ("default"))) NSString *const coreNumberPage(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const colorWaterPlatform(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const modulePrettyPage(NSString *value);/** 即时聊天*/
