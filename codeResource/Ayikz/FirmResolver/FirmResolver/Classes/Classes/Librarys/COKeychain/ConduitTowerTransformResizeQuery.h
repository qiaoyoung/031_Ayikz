...
NS_ASSUME_NONNULL_BEGIN
	...
	#define ConduitTowerTransformResize_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define ConduitTowerTransformResize_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef ConduitTowerTransformResize_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, ConduitTowerTransformResizeQuerySynchronizationMode) {
...
#ifdef ConduitTowerTransformResize_ACCESS_GROUP_AVAILABLE
