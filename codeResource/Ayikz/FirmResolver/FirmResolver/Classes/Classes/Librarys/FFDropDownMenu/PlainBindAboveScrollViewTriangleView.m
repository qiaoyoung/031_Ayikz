...
// __CLOSE_PRINT__
//
//  PlainBindAboveScrollViewTriangleView.m
...
//: @interface PlainBindAboveScrollViewTriangleView ()
@interface PlainBindAboveScrollViewTriangleView ()

//: @end
@end

//: @implementation PlainBindAboveScrollViewTriangleView
@implementation PlainBindAboveScrollViewTriangleView

//: - (void)setTriangleColor:(UIColor *)triangleColor {
- (void)setPlain:(UIColor *)triangleColor {
    //: _triangleColor = triangleColor;
    _plain = triangleColor;
