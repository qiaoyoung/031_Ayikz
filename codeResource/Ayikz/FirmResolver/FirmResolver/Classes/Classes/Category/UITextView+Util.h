...
@property (nonatomic, assign) CGFloat inside;
/* 占位文字颜色 */
...
@property (nonatomic, assign) CGFloat turningTranslate;
...
- (void)spotPass:(CGFloat)maxHeight employ:(textViewHeightDidChangedBlock)textViewHeightDidChanged;
