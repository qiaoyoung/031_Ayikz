//
//  AAAA_FFFSessionViewController_BBBB.h
// AAAA_MyUserKit_BBBB
//
//  Created by NetEase.
...
@interface AAAA_FFFSessionViewController_BBBB : UIViewController<AAAA_NIMSessionInteractorDelegate_BBBB,AAAA_NIMInputActionDelegate_BBBB,AAAA_FFFMessageCellProtocol_BBBBFFFMessageCell_BBBBDelegate_BBBB,NIMChatManagerDelegate,NIMConversationManagerDelegate,NIMChatExtendManagerDelegate>

@property (nonatomic, strong)  UITableView *tableView;

@property (nonatomic, strong)  AAAA_FFFInputView_BBBB *sessionInputView;
