//
//  AAAA_ZMONPolicyPrivacyViewController_BBBB.m
//  NIM
//
...
@interface AAAA_ZMONPolicyPrivacyViewController_BBBB ()<WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler> {
...
@implementation AAAA_ZMONPolicyPrivacyViewController_BBBB
