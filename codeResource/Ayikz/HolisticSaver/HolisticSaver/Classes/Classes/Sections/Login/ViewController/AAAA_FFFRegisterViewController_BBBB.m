//
//  AAAA_FFFRegisterViewController_BBBB.m
//  NIM
//
...
@interface AAAA_FFFRegisterViewController_BBBB () <UITextFieldDelegate>
...
@implementation AAAA_FFFRegisterViewController_BBBB
...
//    }
    ...
    AAAA_USERRegistConfigManager_BBBB *manager = [AAAA_USERRegistConfigManager_BBBB shareConfigManager];
    ...
    @weakify(self);
    [AAAA_USERRegistConfigManager_BBBB firstSendRegistName:_usernameTextField.text pd:_passwordTextField.text RequestWithComplete:^(BOOL sucess, NSString *msg) {
        @strongify(self)
        if (sucess) {
            AAAA_RegisterInfoViewController_BBBB *vc = [[AAAA_RegisterInfoViewController_BBBB alloc]init];
